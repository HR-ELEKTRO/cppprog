    ...
    \begin{titlepage}
        ...
        \makebox[\textwidth]{%
            ...
            \iftoggle{ebook}{
                ...
                % Aangepast vanwege lange titel
                \node[scale=1.8] at (\x@modcode,\y@modtitel) {\hbox{\sffamily \titel}};
            }
            \end{tikzpicture}
        }\par
        \iftoggle{ebook}{
...
%LET OP! Specifiek voor dit document vanwege \modulecode
...
\iftoggle{ebook}{
    \hypersetup{
        ...
        linkcolor=blue,
        urlcolor=blue,
        %LET OP! Specifiek voor dit document vanwege \Cpp in \titel
